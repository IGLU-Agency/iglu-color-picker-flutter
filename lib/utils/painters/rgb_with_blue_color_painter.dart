...
class IGRgbWithBlueColorPainter extends CustomPainter {
  const IGRgbWithBlueColorPainter({
    required this.color,
    this.borderRadius,
    this.pointerColor,
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Gradient gradientH = LinearGradient(
      colors: [
        Color.fromRGBO(0, 255, color.blue, 1),
        Color.fromRGBO(255, 255, color.blue, 1),
      ],
    );
    final Gradient gradientV = LinearGradient(
      ...
      colors: [
        Color.fromRGBO(255, 255, color.blue, 1),
        Color.fromRGBO(255, 0, color.blue, 1),
      ],
    );
    canvas
      ..drawRRect(
